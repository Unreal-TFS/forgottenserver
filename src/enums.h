...
enum ConditionParam_t
{
	...
	CONDITION_PARAM_SKILL_MELEEPERCENT_TOTAL = 57,
	CONDITION_PARAM_SKILL_FISTPERCENT_TOTAL = 58,
	CONDITION_PARAM_SKILL_CLUBPERCENT_TOTAL = 59,
	CONDITION_PARAM_SKILL_SWORDPERCENT_TOTAL = 60,
	CONDITION_PARAM_SKILL_AXEPERCENT_TOTAL = 61,
	CONDITION_PARAM_SKILL_DISTANCEPERCENT_TOTAL = 62,
	CONDITION_PARAM_SKILL_SHIELDPERCENT_TOTAL = 63,
	CONDITION_PARAM_SKILL_FISHINGPERCENT_TOTAL = 64,
	CONDITION_PARAM_STAT_MAGICPOINTSPERCENT_TOTAL = 65,
};

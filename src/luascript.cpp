...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(L, CONDITION_PARAM_SKILL_MELEEPERCENT_TOTAL);
	registerEnum(L, CONDITION_PARAM_SKILL_FISTPERCENT_TOTAL);
	registerEnum(L, CONDITION_PARAM_SKILL_CLUBPERCENT_TOTAL);
	registerEnum(L, CONDITION_PARAM_SKILL_SWORDPERCENT_TOTAL);
	registerEnum(L, CONDITION_PARAM_SKILL_AXEPERCENT_TOTAL);
	registerEnum(L, CONDITION_PARAM_SKILL_DISTANCEPERCENT_TOTAL);
	registerEnum(L, CONDITION_PARAM_SKILL_SHIELDPERCENT_TOTAL);
	registerEnum(L, CONDITION_PARAM_SKILL_FISHINGPERCENT_TOTAL);
	registerEnum(L, CONDITION_PARAM_STAT_MAGICPOINTSPERCENT_TOTAL);
